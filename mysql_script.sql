...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1, NULL, '/', NULL, NULL, '所有', NULL, NULL, NULL, NULL, NULL, 1);
INSERT INTO `sys_permission` VALUES (2, NULL, '/', '/home', 'Home', '员工资料', 'fa fa-user-circle-o', NULL, 1, 1, NULL, 1);
INSERT INTO `sys_permission` VALUES (3, NULL, '/', '/home', 'Home', '人事管理', 'fa fa-address-card-o', NULL, 1, 1, NULL, 1);
INSERT INTO `sys_permission` VALUES (4, NULL, '/', '/home', 'Home', '薪资管理', 'fa fa-money', NULL, 1, 1, NULL, 1);
INSERT INTO `sys_permission` VALUES (5, NULL, '/', '/home', 'Home', '统计管理', 'fa fa-bar-chart', NULL, 1, 1, NULL, 1);
INSERT INTO `sys_permission` VALUES (6, NULL, '/', '/home', 'Home', '系统管理', 'fa fa-windows', NULL, 1, 1, NULL, 1);
INSERT INTO `sys_permission` VALUES (7, NULL, '/employee/basic/**', '/emp/basic', 'EmpBasic', '基本资料', NULL, NULL, 1, 2, NULL, 1);
INSERT INTO `sys_permission` VALUES (8, NULL, '/employee/advanced/**', '/emp/adv', 'EmpAdv', '高级资料', NULL, NULL, 1, 2, NULL, 0);
INSERT INTO `sys_permission` VALUES (9, NULL, '/personnel/emp/**', '/per/emp', 'PerEmp', '员工资料', NULL, NULL, 1, 3, NULL, 0);
INSERT INTO `sys_permission` VALUES (10, NULL, '/personnel/ec/**', '/per/ec', 'PerEc', '员工奖惩', NULL, NULL, 1, 3, NULL, 1);
INSERT INTO `sys_permission` VALUES (11, NULL, '/personnel/train/**', '/per/train', 'PerTrain', '员工培训', NULL, NULL, 1, 3, NULL, 1);
INSERT INTO `sys_permission` VALUES (12, NULL, '/personnel/salary/**', '/per/salary', 'PerSalary', '员工调薪', NULL, NULL, 1, 3, NULL, 1);
INSERT INTO `sys_permission` VALUES (13, NULL, '/personnel/remove/**', '/per/mv', 'PerMv', '员工调动', NULL, NULL, 1, 3, NULL, 1);
INSERT INTO `sys_permission` VALUES (14, NULL, '/salary/sob/**', '/sal/sob', 'SalSob', '工资账套管理', NULL, NULL, 1, 4, NULL, 1);
INSERT INTO `sys_permission` VALUES (15, NULL, '/salary/sobcfg/**', '/sal/sobcfg', 'SalSobCfg', '员工账套设置', NULL, NULL, 1, 4, NULL, 1);
INSERT INTO `sys_permission` VALUES (16, NULL, '/salary/table/**', '/sal/table', 'SalTable', '工资表管理', NULL, NULL, 1, 4, NULL, 1);
INSERT INTO `sys_permission` VALUES (17, NULL, '/salary/month/**', '/sal/month', 'SalMonth', '月末处理', NULL, NULL, 1, 4, NULL, 1);
INSERT INTO `sys_permission` VALUES (18, NULL, '/salary/search/**', '/sal/search', 'SalSearch', '工资表查询', NULL, NULL, 1, 4, NULL, 1);
INSERT INTO `sys_permission` VALUES (19, NULL, '/statistics/all/**', '/sta/all', 'StaAll', '综合信息统计', NULL, NULL, 1, 5, NULL, 1);
INSERT INTO `sys_permission` VALUES (20, NULL, '/statistics/score/**', '/sta/score', 'StaScore', '员工积分统计', NULL, NULL, 1, 5, NULL, 1);
INSERT INTO `sys_permission` VALUES (21, NULL, '/statistics/personnel/**', '/sta/pers', 'StaPers', '人事信息统计', NULL, NULL, 1, 5, NULL, 1);
INSERT INTO `sys_permission` VALUES (22, NULL, '/statistics/recored/**', '/sta/record', 'StaRecord', '人事记录统计', NULL, NULL, 1, 5, NULL, 1);
INSERT INTO `sys_permission` VALUES (23, NULL, '/system/basic/**', '/sys/basic', 'SysBasic', '基础信息设置', NULL, NULL, 1, 6, NULL, 1);
INSERT INTO `sys_permission` VALUES (24, NULL, '/system/cfg/**', '/sys/cfg', 'SysCfg', '系统管理', NULL, NULL, 1, 6, NULL, 1);
INSERT INTO `sys_permission` VALUES (25, NULL, '/system/log/**', '/sys/log', 'SysLog', '操作日志管理', NULL, NULL, 1, 6, NULL, 1);
INSERT INTO `sys_permission` VALUES (26, NULL, '/system/hr/**', '/sys/hr', 'SysHr', '操作员管理', NULL, NULL, 1, 6, NULL, 1);
INSERT INTO `sys_permission` VALUES (27, NULL, '/system/data/**', '/sys/data', 'SysData', '备份恢复数据库', NULL, NULL, 1, 6, NULL, 1);
INSERT INTO `sys_permission` VALUES (28, NULL, '/system/init/**', '/sys/init', 'SysInit', '初始化数据库', NULL, NULL, 1, 6, NULL, 1);
