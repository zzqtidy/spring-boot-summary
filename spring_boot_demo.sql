...
-- ----------------------------
INSERT INTO `job_entity` VALUES (1, 'first', 'helloworld', '0/2 * * * * ? ', NULL, '1', '第一个', '', NULL, 'OPEN');
INSERT INTO `job_entity` VALUES (2, 'second', 'helloworld', '0/5 * * * * ? ', NULL, '2', '第二个', NULL, NULL, 'OPEN');
INSERT INTO `job_entity` VALUES (3, 'third', 'helloworld', '0/15 * * * * ? ', NULL, '3', '第三个', NULL, NULL, 'OPEN');
INSERT INTO `job_entity` VALUES (4, 'four', 'helloworld', '0 0/1 * * * ? *', NULL, '4', '第四个', NULL, NULL, 'CLOSE');
INSERT INTO `job_entity` VALUES (5, 'OLAY Job', 'Nomal', '0 0/2 * * * ?', NULL, '5', '第五个', NULL, 'C:\\EalenXie\\Download\\JDE-Order-1.0-SNAPSHOT.jar', 'CLOSE');
